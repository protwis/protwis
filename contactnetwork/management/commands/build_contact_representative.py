...
class Command(BaseCommand):
    ...
    def receptor_representatives(self):
        ...
        structures = Structure.objects.filter(structure_type__origin='experiment').prefetch_related(
            "pdb_code",
            "state",
    ...
    def class_level_contacts(self):
        ...
        structures = Structure.objects.filter(refined=False, structure_type__origin='experiment').prefetch_related(
            "pdb_code",
            "state",
            "protein_conformation__protein__parent__family",
