...
class ImportHomologyModel():
    receptor_segments = [i.slug for i in ProteinSegment.objects.filter(proteinfamily='GPCR')]
    def __init__(self, receptor, zip_path='./structure/complex_models_zip/'):
    ...
    def parse_model(self, modelchain):
        ...
        # return AlignmentClassPlaceholder(reference_dict, reference_dict, reference_dict), main_pdb_array
...
class AlignmentClassPlaceholder():
    def __init__(self, reference_dict, template_dict, alignment_dict):
