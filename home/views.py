...
def index(request):
    ...
    try:
        ...
        context['release_statistics'].insert(3, {"statistics_type": "Struture models", "value": "GPCRs: {}, GPCR-G protein complexes: {}".format(stats["GPCR structure models"], stats["GPCR-G protein structure models"]) })
