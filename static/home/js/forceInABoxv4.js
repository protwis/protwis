...
(function (global, factory) {
    ...
    function forceInABox() {
      ...
      function initializeWithTreemap() {
        var treemap = d3v4.treemap().size(force.size());
    
        tree = d3v4.hierarchy(getGroupsTree())
          .sum(function(d) {
            return d.size;
          })
          .sort(function(a, b) {
      ...
      function initializeWithForce() {
        ...
        net = getGroupsGraph();
        templateForce = d3v4.forceSimulation(net.nodes)
          .force("x", d3v4.forceX(size[0] / 2).strength(0.1))
          .force("y", d3v4.forceY(size[1] / 2).strength(0.1))
          .force(
            "collide",
            d3v4.forceCollide(function(d) {
              return d.r;
            }).iterations(4)
          )
          .force("charge", d3v4.forceManyBody().strength(forceCharge))
          .force(
            "links",
            d3v4.forceLink(net.nodes.length ? net.links : [])
