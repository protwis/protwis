...
function () {
    ...
    d3.layout.phylotree = function (container) {
        ...
        (draw_branch = draw_line), (draw_scale_bar = null), (rescale_node_span = 1), (count_listener_handler = function () {
        }), (layout_listener_handler = function () {
        }), (node_styler = undefined), (edge_styler = undefined), (shown_font_size = font_size), (selection_attribute_name =
