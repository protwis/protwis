...
(function (global, factory) {
    ...
    var frame = 0, // is an animation frame pending?
        ...
        setFrame = typeof window === "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) (f) { setTimeout(f, 17); };
        ...
        interval.every = function(step) {
          ...
          return !isFinite(step) || !(step > 0) ? null
              ...
              : interval.filter(field
                  ...
                  (d) { return interval.count(0, d) % step === 0; });
        };
      }
