...
(function($) {
			...
			$("*[id^=resultC]").each(function() {
				...
				for (var i = 6; i < $(this).attr("id").length; i++) {
					if ($(this).attr("id").substring(i + 1, i + 2) === "1") {
						try {
							this.listnames.push(opts.series[i - 6].name);
						} catch (err) {}
					}
				}
				this.empty = true;
		...
		function setValuesforFillCountVenn(values) {
			if (values.A) {
				$("#resultC100000").html(values.A);
			}
			if (values.B) {
				$("#resultC010000").html(values.B);
			}
			if (values.C) {
				$("#resultC001000").html(values.C);
			}
			if (values.D) {
				$("#resultC000100").html(values.D);
			}
			if (values.E) {
				$("#resultC000010").html(values.E);
			}
			if (values.F) {
				$("#resultC000001").html(values.F);
			}
			if (values.AB) {
				$("#resultC110000").html(values.AB);
			}
			if (values.AC) {
				$("#resultC101000").html(values.AC);
			}
			if (values.AD) {
				$("#resultC100100").html(values.AD);
			}
			if (values.AE) {
				$("#resultC100010").html(values.AE);
			}
			if (values.AF) {
				$("#resultC100001").html(values.AF);
			}
			if (values.BC) {
				$("#resultC011000").html(values.BC);
			}
			if (values.BD) {
				$("#resultC010100").html(values.BD);
			}
			if (values.BE) {
				$("#resultC010010").html(values.BE);
			}
			if (values.BF) {
				$("#resultC010001").html(values.BF);
			}
			if (values.CD) {
				$("#resultC001100").html(values.CD);
			}
			if (values.CE) {
				$("#resultC001010").html(values.CE);
			}
			if (values.CF) {
				$("#resultC001001").html(values.CF);
			}
			if (values.DE) {
				$("#resultC000110").html(values.DE);
			}
			if (values.DF) {
				$("#resultC000101").html(values.DF);
			}
			if (values.EF) {
				$("#resultC000011").html(values.EF);
			}
			if (values.ABC) {
				$("#resultC111000").html(values.ABC);
			}
			if (values.ABD) {
				$("#resultC110100").html(values.ABD);
			}
			if (values.ABE) {
				$("#resultC110010").html(values.ABE);
			}
			if (values.ABF) {
				$("#resultC110001").html(values.ABF);
			}
			if (values.ACD) {
				$("#resultC101100").html(values.ACD);
			}
			if (values.ACE) {
				$("#resultC101010").html(values.ACE);
			}
			if (values.ACF) {
				$("#resultC101001").html(values.ACF);
			}
			if (values.ADE) {
				$("#resultC100110").html(values.ADE);
			}
			if (values.ADF) {
				$("#resultC100101").html(values.ADF);
			}
			if (values.AEF) {
				$("#resultC100011").html(values.AEF);
			}
			if (values.BCD) {
				$("#resultC011100").html(values.BCD);
			}
			if (values.BCE) {
				$("#resultC011010").html(values.BCE);
			}
			if (values.BCF) {
				$("#resultC011001").html(values.BCF);
			}
			if (values.BDE) {
				$("#resultC010110").html(values.BDE);
			}
			if (values.BDF) {
				$("#resultC010101").html(values.BDF);
			}
			if (values.BEF) {
				$("#resultC010011").html(values.BEF);
			}
			if (values.CDE) {
				$("#resultC001110").html(values.CDE);
			}
			if (values.CDF) {
				$("#resultC001101").html(values.CDF);
			}
			if (values.CEF) {
				$("#resultC001011").html(values.CEF);
			}
			if (values.DEF) {
				$("#resultC000111").html(values.DEF);
			}
			if (values.ABCD) {
				$("#resultC111100").html(values.ABCD);
			}
			if (values.ABCE) {
				$("#resultC111010").html(values.ABCE);
			}
			if (values.ABCF) {
				$("#resultC111001").html(values.ABCF);
			}
			if (values.ABDE) {
				$("#resultC110110").html(values.ABDE);
			}
			if (values.ABDF) {
				$("#resultC110101").html(values.ABDF);
			}
			if (values.ACDE) {
				$("#resultC101110").html(values.ACDE);
			}
			if (values.ACDF) {
				$("#resultC101101").html(values.ACDF);
			}
			if (values.BCDE) {
				$("#resultC011110").html(values.BCDE);
			}
			if (values.BCDF) {
				$("#resultC011101").html(values.BCDF);
			}
			if (values.CDEF) {
				$("#resultC001111").html(values.CDEF);
			}
			if (values.BDEF) {
				$("#resultC010111").html(values.BDEF);
			}
			if (values.BCEF) {
				$("#resultC011011").html(values.BCEF);
			}
			if (values.ADEF) {
				$("#resultC100111").html(values.ADEF);
			}
			if (values.ACEF) {
				$("#resultC101011").html(values.ACEF);
			}
			if (values.ABEF) {
				$("#resultC110011").html(values.ABEF);
			}
			if (values.ABCDE) {
				$("#resultC111110").html(values.ABCDE);
			}
			if (values.ABCDF) {
				$("#resultC111101").html(values.ABCDF);
			}
			if (values.ABCEF) {
				$("#resultC111011").html(values.ABCEF);
			}
			if (values.ABDEF) {
				$("#resultC110111").html(values.ABDEF);
			}
			if (values.ACDEF) {
				$("#resultC101111").html(values.ACDEF);
			}
			if (values.BCDEF) {
				$("#resultC011111").html(values.BCDEF);
			}
			if (values.ABCDEF) {
				$("#resultC111111").html(values.ABCDEF);
			}
		}
		...
		function fillCountVenn() {
			...
			if (opts.series[0].name.A) {
				$("#label1").html(opts.series[0].name.A);
			}
			if (opts.series[0].name.B) {
				$("#label2").html(opts.series[0].name.B);
			}
			if (opts.series[0].name.C) {
				$("#label3").html(opts.series[0].name.C);
			}
			if (opts.series[0].name.D) {
				$("#label4").html(opts.series[0].name.D);
			}
			if (opts.series[0].name.E) {
				$("#label5").html(opts.series[0].name.E);
			}
			if (opts.series[0].name.F) {
				$("#label6").html(opts.series[0].name.F);
			}
			...
			$("*[id^=resultC]").each(function() {
				...
				for (var i = 6; i < $(this).attr("id").length; i++) {
					if ($(this).attr("id").substring(i + 1, i + 2) === "1") {
						try {
							if (i - 6 == 0) {
								this.listnames.push(opts.series[0].name.A);
							} else if (i - 6 == 1) {
								this.listnames.push(opts.series[0].name.B);
							} else if (i - 6 == 2) {
								this.listnames.push(opts.series[0].name.C);
							} else if (i - 6 == 3) {
								this.listnames.push(opts.series[0].name.D);
							} else if (i - 6 == 4) {
								this.listnames.push(opts.series[0].name.E);
							} else if (i - 6 == 5) {
								this.listnames.push(opts.series[0].name.F);
							}
						} catch (err) {}
					}
				}
		...
		function getVennType() {
			...
			if (opts.series.length > 1) {
				...
				if (opts.series[0] != undefined && opts.series[0].name.A) {
					var count = 0;
					for (let i in opts.series[0].name) {
						count++;
					}
		...
		this.each(function() {
			...
			if (opts.exporting === true) {
				addExportModule($t, extraheight, type[0]);
			}
			...
			$(".number-black").hover(
				function() {
					...
					if (opts.searchInput != null && opts.searchInput.val() != '') {
						activesearch = true;
					}
