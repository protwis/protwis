...
"""
testing backend search / temporaryly unused
"""
# from django.core.paginator import Paginator
# from django.shortcuts import render
# class BiasedBrowserBackEnd(ListView):
#     template_name = 'BiasedBrowserBackEnd.html'
#     paginate_by = 100
#     context_object_name = 'data'
#
#     def validate_children(self, prepare_data):
#         final_list = list()
#         for i in prepare_data:
#             lenght = len(i['biasdata'])
#             if lenght >= 2:
#                 for j in range(lenght,5):
#                     temp_dict = dict()
#                     temp_dict['pathway'] = ''
#                     temp_dict['bias'] = ''
#                     temp_dict['cell_line'] = ''
...
#                     temp_dict['ligand_function'] = ''
#                     temp_dict['order_no'] = lenght
#                     i['biasdata'].append(temp_dict)
#                     lenght+=1
#                 test = sorted(i['biasdata'], key=lambda x: x['order_no'],
#                               reverse=True)
#                 i['biasdata'] = test
#                 final_list.append(i)
#         return final_list
...
#         prepare_data = self.process_data(content)
#         final_list = list()
#         # check for bias data size
#         final_list = self.validate_children(prepare_data)
#
#         context.update({'data': final_list })
#         return final_list
#
#     def process_data(self, content):
#         '''
...
#             doubles = []
#             # TODO: mutation residue
#             temp['experiment_id'] = str(instance.id)
#             temp['authors'] = str(instance.publication.authors)
#             temp['web_link'] = str(instance.publication.web_link)
#             temp['publication'] = str(instance.publication)
#             temp['ligand'] = str(instance.ligand)
#             temp['source'] = str(instance.source)
#             temp['chembl'] = str(instance.chembl)
#             temp['endogenous_ligand'] = str(instance.endogenous_ligand)
#             temp['vendor_quantity'] = int(instance.vendor_quantity)
#             temp['publication_quantity'] = int(instance.article_quantity)
#             temp['lab_quantity'] = str(instance.labs_quantity)
#             temp['reference_ligand'] = str(instance.reference_ligand)
#             temp['primary'] =   str(instance.primary)
#             temp['secondary'] = str(instance.secondary)
#             if instance.receptor:
#                 temp['class'] = str(instance.receptor.family.parent.parent.parent.name.replace('Class','').strip())
#                 temp['receptor'] = str(instance.receptor)
#                 temp['uniprot'] = instance.receptor.entry_short
#                 temp['IUPHAR'] = str(instance.receptor.name.split(' ', 1)[0].strip())
#             else:
#                 temp['receptor'] = 'Error appeared'
#             temp['biasdata'] = list()
#             increment_assay = 0
...
#                 if entry.order_no < 5:
#                     temp_dict = dict()
#                     temp_dict['emax_reference_ligand'] = str(entry.emax_ligand_reference)
#                     temp_dict['family'] = str(entry.family)
#                     temp_dict['show_family'] = str(entry.signalling_protein)
#                     temp_dict['signalling_protein'] = str(entry.signalling_protein)
#                     temp_dict['cell_line'] = str(entry.cell_line)
#                     temp_dict['assay_type'] = str(entry.assay_type)
#                     temp_dict['assay_measure'] = str(entry.assay_measure)
#                     temp_dict['assay_time_resolved'] = str(entry.assay_time_resolved)
#                     temp_dict['ligand_function'] = str(entry.ligand_function)
#                     temp_dict['quantitive_measure_type'] = str(entry.quantitive_measure_type)
#                     temp_dict['quantitive_activity'] = str(entry.quantitive_activity)
#                     temp_dict['quantitive_activity_initial'] = str(entry.quantitive_activity_initial)
#                     temp_dict['quantitive_unit'] = str(entry.quantitive_unit)
#                     temp_dict['qualitative_activity'] = str(entry.qualitative_activity)
#                     temp_dict['quantitive_efficacy'] = str(entry.quantitive_efficacy)
#                     temp_dict['efficacy_measure_type'] = str(entry.efficacy_measure_type)
#                     temp_dict['efficacy_unit'] = str(entry.efficacy_unit)
#                     temp_dict['order_no'] =  int(entry.order_no)
#                     temp_dict['t_coefficient'] = str(entry.t_coefficient)
#                     if entry.t_value != None and entry.t_value !='None':
#                         temp_dict['t_value'] = str(entry.t_value)
#                     else:
#                         temp_dict['t_value'] = ''
#
#                     if entry.t_factor != None and entry.t_factor !='None':
#                         temp_dict['t_factor'] = str(entry.t_factor)
#                     else:
#                         temp_dict['t_factor'] = ''
#
#                     if entry.potency != None and entry.potency !='None':
#                         temp_dict['potency'] =  str(entry.potency)
#                     else:
#                         temp_dict['potency'] = ''
#
#                     if entry.log_bias_factor != None and entry.log_bias_factor !='None':
#                         temp_dict['log_bias_factor'] = str(entry.log_bias_factor)
#                     else:
#                         temp_dict['log_bias_factor'] = ''
#
#                     temp_dict['emax_ligand_reference'] = str(entry.emax_ligand_reference)
#
#                     temp['biasdata'].append(temp_dict)
#
#                     doubles.append(temp_dict)
