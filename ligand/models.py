...
class AssayExperiment(models.Model):
    ...
    standard_activity_value = models.CharField(max_length=10, null=True)
    p_activity_value = models.CharField(max_length=10, null=True) #Only 1 value, median/max fot GTP (p activity)
