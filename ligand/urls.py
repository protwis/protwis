...
urlpatterns = [
    ...
    path('subtype_bias_rankorder', views.BiasedSignallingOnTheFlyCalculation.as_view(label='bias',subtype=True), name='biased_rank_order'),
    path('subtype_bias_rankorder_path_bias', views.BiasedSignallingOnTheFlyCalculation.as_view(label='bias', subtype=True, balanced=True), name='biased_rank_order'),
