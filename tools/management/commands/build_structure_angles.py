...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if incremental_update:
            ...
            self.references = Structure.objects.filter(structure_type__origin='experiment').exclude(id__in=done_structures).prefetch_related('pdb_code','pdb_data','protein_conformation__protein','protein_conformation__state').order_by('protein_conformation__protein')
        else:
            ...
            self.references = Structure.objects.filter(structure_type__origin='experiment').prefetch_related('pdb_code','pdb_data','protein_conformation__protein','protein_conformation__state').order_by('protein_conformation__protein')
