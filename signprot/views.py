...
'5g53' : [
        ...
        ['A','Q',207,'5.68x68','C','D',381,'G.H5.13', ["h-bond donor-acceptor", "polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
...
'5uz7' : [
        ...
        ['R','H',331,'-','A','Y',358,'G.h4s6.20', ["h-bond acceptor-donor", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ...
        ['R','T',330,'-','A','Y',358,'G.h4s6.20', ["h-bond acceptor-donor", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
...
'6ddf' : [
        ...
        ['R','T',103,'2.39x39','A','D',350,'G.H5.22', ["h-bond donor-acceptor", "polar-sidechain-backbone", "van-der-waals"]],
...
'6e3y' : [
        ...
        ['R','R',173,'2.46x46','A','Q',390,'G.H5.22', ["h-bond donor-acceptor", "polar-sidechain-sidechain", "polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
        ...
        ['R','R',336,'6.40x40','A','E',392,'G.H5.24', ["ionic", "h-bond donor-acceptor", "polar-sidechain-sidechain", "polar-sidechain-backbone", "van-der-waals"]],
...
'6gdg' : [
        ...
        ['A','R',293,'8.48x48','D','E',382,'G.H5.24', ["h-bond donor-acceptor", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['A','L',110,'34.51x51','D','I',373,'G.H5.15', ["hydrophobic"]],
        ],
'6nbf' : [
        ['R','T',392,'-','A','Y',358,'G.h4s6.20', ["polar-sidechain-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','T',392,'-','A','R',385,'G.H5.17', ["polar-backbone-sidechain"]],
        ['R','K',388,'5.64x64','A','D',381,'G.H5.13', ["ionic", "polar-sidechain-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','R',219,'2.46x46','A','Q',390,'G.H5.22', ["polar-sidechain-sidechain", "polar-sidechain-backbone", "hydrophobic"]],
        ['R','I',310,'3.58x58','A','L',388,'G.H5.20', ["hydrophobic"]],
        ['R','E',391,'-','A','D',381,'G.H5.13', ["polar-sidechain-sidechain"]],
        ['R','K',405,'6.37x37','A','L',394,'G.H5.26', ["polar-sidechain-sidechain", "hydrophobic"]],
        ['R','R',219,'2.46x46','A','Y',391,'G.H5.23', ["cation-pi", "van-der-waals", "hydrophobic"]],
        ['R','L',385,'5.61x61','A','L',393,'G.H5.25', ["hydrophobic"]],
        ['R','L',385,'5.61x61','A','L',394,'G.H5.26', ["hydrophobic"]],
        ['R','L',306,'3.54x54','A','Y',391,'G.H5.23', ["van-der-waals", "hydrophobic"]],
        ['R','K',388,'5.64x64','A','L',394,'G.H5.26', ["hydrophobic"]],
        ['R','L',309,'3.57x57','A','Y',391,'G.H5.23', ["van-der-waals", "hydrophobic"]],
        ['R','I',310,'3.58x58','A','Q',384,'G.H5.16', ["polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','K',388,'5.64x64','A','R',385,'G.H5.17', ["polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','S',409,'6.41x41','A','L',393,'G.H5.25', ["polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
        ['R','K',388,'5.64x64','A','L',388,'G.H5.20', ["hydrophobic"]],
        ['R','L',309,'3.57x57','A','H',387,'G.H5.19', ["polar-backbone-sidechain", "hydrophobic"]],
        ['R','L',389,'5.65x65','A','L',394,'G.H5.26', ["hydrophobic"]],
        ['R','K',405,'6.37x37','A','L',393,'G.H5.25', ["polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
        ['R','A',313,'-','A','R',380,'G.H5.12', ["hydrophobic"]],
        ['R','Y',305,'3.53x53','A','Y',391,'G.H5.23', ["van-der-waals"]],
        ['R','G',464,'8.48x48','A','E',392,'G.H5.24', ["polar-backbone-sidechain"]],
        ['R','L',385,'5.61x61','A','L',388,'G.H5.20', ["hydrophobic"]],
        ['R','K',388,'5.64x64','A','Q',384,'G.H5.16', ["h-bond donor-acceptor", "polar-sidechain-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','E',391,'-','A','R',385,'G.H5.17', ["ionic", "polar-sidechain-sidechain"]],
        ['R','N',463,'8.47x47','A','E',392,'G.H5.24', ["polar-sidechain-sidechain"]],
        ],
'6oij' : [
        ['R','L',131,'34.51x51','A','L',40,'G.S1.02', ["hydrophobic"]],
        ['R','P',130,'34.50x50','A','L',349,'G.H5.16', ["hydrophobic"]],
        ['R','K',362,'6.32x32','A','N',357,'G.H5.24', ["polar-sidechain-sidechain", "hydrophobic"]],
        ['R','C',421,'7.56x56','A','N',357,'G.H5.24', ["polar-sidechain-sidechain", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','N',422,'8.47x47','A','E',355,'G.H5.22', ["polar-sidechain-sidechain", "polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
        ['R','L',367,'6.37x37','A','L',358,'G.H5.25', ["hydrophobic"]],
        ['R','A',135,'34.55x55','A','R',38,'G.hns1.03', ["polar-backbone-sidechain", "hydrophobic"]],
        ['R','N',60,'2.39x39','A','N',352,'G.H5.19', ["polar-sidechain-sidechain"]],
        ['R','S',126,'3.53x53','A','Y',356,'G.H5.23', ["h-bond donor-acceptor", "polar-sidechain-sidechain", "van-der-waals"]],
        ['R','Q',226,'-','A','I',323,'G.h4s6.20', ["van-der-waals", "hydrophobic"]],
        ['R','T',215,'5.65x65','A','V',359,'G.H5.26', ["polar-sidechain-sidechain"]],
        ['R','R',134,'34.54x54','A','I',348,'G.H5.15', ["hydrophobic"]],
        ['R','R',218,'5.68x68','A','V',359,'G.H5.26', ["polar-sidechain-sidechain"]],
        ['R','C',421,'7.56x56','A','Y',356,'G.H5.23', ["polar-sidechain-backbone", "hydrophobic"]],
        ['R','R',123,'3.50x50','A','Y',356,'G.H5.23', ["cation-pi", "van-der-waals", "hydrophobic"]],
        ['R','L',222,'5.72x72','A','I',323,'G.h4s6.20', ["hydrophobic"]],
        ['R','R',134,'34.54x54','A','L',40,'G.S1.02', ["van-der-waals", "hydrophobic"]],
        ['R','R',134,'34.54x54','A','R',37,'G.hns1.02', ["polar-sidechain-backbone", "polar-backbone-sidechain", "van-der-waals"]],
        ['R','C',421,'7.56x56','A','E',355,'G.H5.22', ["van-der-waals"]],
        ['R','T',366,'6.36x36','A','N',357,'G.H5.24', ["hydrophobic"]],
        ['R','A',135,'34.55x55','A','I',199,'G.S3.01', ["van-der-waals", "hydrophobic"]],
        ['R','L',131,'34.51x51','A','I',348,'G.H5.15', ["van-der-waals", "hydrophobic"]],
        ['R','L',225,'5.75x75','A','F',339,'G.H5.06', ["hydrophobic"]],
        ['R','T',215,'5.65x65','A','L',353,'G.H5.20', ["hydrophobic"]],
        ['R','R',426,'8.51x51','A','N',357,'G.H5.24', ["polar-sidechain-sidechain"]],
        ['R','V',127,'3.54x54','A','L',349,'G.H5.16', ["van-der-waals", "hydrophobic"]],
        ['R','L',225,'5.75x75','A','Y',325,'G.S6.02', ["hydrophobic"]],
        ['R','Q',226,'-','A','I',324,'G.S6.01', ["polar-sidechain-backbone"]],
        ['R','A',363,'6.33x33','A','L',358,'G.H5.25', ["hydrophobic"]],
        ['R','G',227,'-','A','L',310,'G.H4.12', ["hydrophobic"]],
        ['R','G',227,'-','A','F',328,'G.S6.05', ["hydrophobic"]],
        ['R','S',126,'3.53x53','A','N',352,'G.H5.19', ["h-bond acceptor-donor", "polar-sidechain-sidechain", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','L',131,'34.51x51','A','V',344,'G.H5.11', ["hydrophobic"]],
        ['R','L',225,'5.75x75','A','S',326,'G.S6.03', ["van-der-waals"]],
        ['R','R',218,'5.68x68','A','Q',350,'G.H5.17', ["h-bond donor-acceptor", "polar-sidechain-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','P',139,'4.39x39','A','E',28,'G.HN.52', ["hydrophobic"]],
        ['R','P',130,'34.50x50','A','I',348,'G.H5.15', ["hydrophobic"]],
        ['R','L',222,'5.72x72','A','Y',325,'G.S6.02', ["hydrophobic"]],
        ['R','N',60,'2.39x39','A','E',355,'G.H5.22', ["h-bond donor-acceptor", "polar-sidechain-sidechain", "van-der-waals"]],
        ['R','T',138,'4.38x38','A','R',37,'G.hns1.02', ["polar-backbone-sidechain"]],
        ['R','I',211,'5.61x61','A','L',358,'G.H5.25', ["hydrophobic"]],
        ['R','A',135,'34.55x55','A','R',37,'G.hns1.02', ["polar-backbone-sidechain", "van-der-waals"]],
        ['R','R',218,'5.68x68','A','L',349,'G.H5.16', ["hydrophobic"]],
        ['R','V',127,'3.54x54','A','Y',356,'G.H5.23', ["hydrophobic"]],
        ['R','L',225,'5.75x75','A','D',346,'G.H5.13', ["van-der-waals", "hydrophobic"]],
        ['R','R',218,'5.68x68','A','D',346,'G.H5.13', ["ionic", "polar-sidechain-sidechain"]],
        ['R','L',131,'34.51x51','A','F',341,'G.H5.08', ["van-der-waals", "hydrophobic"]],
        ['R','T',215,'5.65x65','A','L',358,'G.H5.25', ["polar-sidechain-backbone", "hydrophobic"]],
        ['R','D',122,'3.49x49','A','Y',356,'G.H5.23', ["polar-sidechain-sidechain", "polar-backbone-sidechain"]],
['R','L',225,'5.75x75','A','A',342,'G.H5.09', ["hydrophobic"]],
['R','R',137,'34.57x57','A','R',37,'G.hns1.02', ["polar-backbone-sidechain"]],
['R','R',218,'5.68x68','A','L',353,'G.H5.20', ["van-der-waals", "hydrophobic"]],
['R','N',60,'2.39x39','A','Y',356,'G.H5.23', ["polar-sidechain-sidechain"]],
['R','L',131,'34.51x51','A','I',199,'G.S3.01', ["hydrophobic"]],
['R','L',131,'34.51x51','A','K',345,'G.H5.12', ["hydrophobic"]],
['R','Q',226,'-','A','Y',325,'G.S6.02', ["hydrophobic"]],
['R','T',366,'6.36x36','A','L',358,'G.H5.25', ["hydrophobic"]],
['R','G',227,'-','A','S',326,'G.S6.03', ["polar-backbone-sidechain"]],
['R','R',134,'34.54x54','A','R',38,'G.hns1.03', ["polar-sidechain-backbone"]],
['R','V',127,'3.54x54','A','L',353,'G.H5.20', ["van-der-waals", "hydrophobic"]],
['R','P',130,'34.50x50','A','K',345,'G.H5.12', ["hydrophobic"]],
],
'6oik' : [
        ['R','R',381,'6.29x29','A','Y',354,'G.H5.26', ["polar-sidechain-sidechain", "polar-backbone-sidechain", "van-der-waals", "hydrophobic"]],
        ['R','N',444,'8.47x47','A','R',349,'G.H5.21', ["polar-sidechain-backbone"]],
        ['R','V',133,'34.55x55','A','K',32,'H.HD.11', ["hydrophobic"]],
        ['R','P',128,'34.50x50','A','I',344,'G.H5.16', ["van-der-waals", "hydrophobic"]],
        ['R','R',381,'6.29x29','A','L',348,'G.H5.20', ["van-der-waals", "hydrophobic"]],
        ['R','I',217,'5.69x69','A','Y',320,'G.h4s6.20', ["hydrophobic"]],
        ['R','C',443,'7.56x56','A','G',352,'G.H5.24', ["polar-sidechain-backbone", "van-der-waals"]],
        ['R','V',125,'3.54x54','A','L',348,'G.H5.20', ["hydrophobic"]],
        ['R','S',215,'5.67x67','A','D',341,'G.H5.13', ["polar-backbone-sidechain", "van-der-waals"]],
        ['R','N',58,'2.39x39','A','C',351,'G.H5.23', ["hydrophobic"]],
        ['R','N',444,'8.47x47','A','G',352,'G.H5.24', ["hydrophobic"]],
        ['R','I',389,'6.37x37','A','L',353,'G.H5.25', ["hydrophobic"]],
        ['R','I',392,'6.40x40','A','L',353,'G.H5.25', ["hydrophobic"]],
        ['R','S',380,'6.28x28','A','Y',354,'G.H5.26', ["polar-backbone-sidechain"]],
        ['R','R',121,'3.50x50','A','C',351,'G.H5.23', ["polar-sidechain-sidechain", "polar-sidechain-backbone", "van-der-waals", "hydrophobic"]],
        ['R','R',381,'6.29x29','A','A',345,'G.H5.17', ["polar-sidechain-backbone"]],
        ['R','R',121,'3.50x50','A','L',353,'G.H5.25', ["hydrophobic"]],
        ['R','P',128,'34.50x50','A','N',347,'G.H5.19', ["polar-backbone-sidechain"]],
        ['R','V',385,'6.33x33','A','Y',354,'G.H5.26', ["hydrophobic"]],
        ['R','L',129,'34.51x51','A','L',195,'G.S3.01', ["hydrophobic"]],
        ['R','T',388,'6.36x36','A','L',353,'G.H5.25', ["polar-sidechain-backbone", "van-der-waals"]],
        ['R','S',213,'5.65x65','A','L',348,'G.H5.20', ["hydrophobic"]],
        ['R','C',124,'3.53x53','A','N',347,'G.H5.19', ["polar-backbone-sidechain"]],
        ['R','K',214,'5.66x66','A','D',341,'G.H5.13', ["polar-backbone-sidechain"]],
        ['R','I',217,'5.69x69','A','D',341,'G.H5.13', ["hydrophobic"]],
        ['R','R',381,'6.29x29','A','D',341,'G.H5.13', ["ionic", "polar-sidechain-sidechain", "polar-sidechain-backbone"]],
        ['R','P',128,'34.50x50','A','I',343,'G.H5.15', ["hydrophobic"]],
        ['R','R',381,'6.29x29','A','I',344,'G.H5.16', ["van-der-waals"]],
        ['R','V',385,'6.33x33','A','L',348,'G.H5.20', ["hydrophobic"]],
        ['R','I',209,'5.61x61','A','L',353,'G.H5.25', ["hydrophobic"]],
        ['R','K',384,'6.32x32','A','Y',354,'G.H5.26', ["hydrophobic"]],
        ],
}
