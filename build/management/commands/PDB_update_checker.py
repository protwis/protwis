...
def scrapping_data(counter, to_download, pdb_codes):
    for code in pdb_codes[counter:]:
        try:
            ...
            if len(revs) == 0:
                ...
                converted = date_conversion(revs[0])
...
def update_pdbs():
    ...
    counter = 0
    start = time.time()
    old_pdbs = scrapping_data(counter, self.old_pdbs, self.pdb_codes)
...
class Command(BaseCommand):
    ...
    to_skip = ['6ORV', '6Z4Q', '6Z4S', '6Z4V', '6YVR', '6Z8N', '6ZA8', '6ZIN', '7B6W', '7PP1', '7F1T', '7XBX'] #don't download these
